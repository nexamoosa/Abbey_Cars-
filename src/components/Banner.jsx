...
export default function Banner() {
  ...
  if (!pathname || pathname === '/' || pathname.startsWith('/admin') || pathname.startsWith('/areas-we-cover') || pathname === '/contact' || pathname === '/booking' || pathname === '/services' || pathname === '/about/our-story' || /^\/services\/[^/]+$/.test(pathname)) return null
